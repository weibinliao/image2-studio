...
assert.match(html, /id="verifySkillButton"/, 'the Skill install section should provide a verification action');
...
assert.match(app, /api\/codex-skill\/verify-local/, 'the webpage should verify local Agent installation');
